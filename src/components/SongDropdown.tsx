          ...
          <div className="p-2">
            <div className="relative">
              <input
                ...
                className="w-full px-2 py-1.5 pr-8 rounded-md border border-fourth bg-canvas font-light text-xs focus:outline-none focus:ring-1 focus:ring-fourth text-fifth placeholder-black/60"
              />
