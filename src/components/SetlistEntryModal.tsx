...
const SetlistEntryModal: React.FC<SetlistEntryModalProps> = ({ 
  ...
  useEffect(() => {
    if (entry) {
      ...
      if (isNewEntry) {
        ...
        console.log('New entry initialized with defaults:', entryWithDefaults);
      } else {
  ...
  const saveGuestAssociations = async (entryId: string) => {
    try {
      ...
      console.log('Guest associations saved successfully');
    } catch (error) {
  ...
  const handleSaveChanges = async () => {
    ...
    try {
      ...
      if (isNewEntry) {
        ...
        console.log('Creating new setlist entry with data:', entryToSave);
        ...
        console.log('Sending insert request with data:', insertData);
        ...
        console.log('Setlist entry created successfully:', data);
        ...
        console.log('Updating setlist entry with data:', entryToSave);
        ...
        console.log('Setlist entry updated successfully');
                        ...
                        supabase
                          ...
                          .then(({ error }) => {
                            if (error) {
                              ...
                              console.log('Setlist entry deleted successfully');
                              onSave(); // Trigger refetch of entries
