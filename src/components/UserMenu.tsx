...
export const UserMenu: React.FC = () => {
  ...
  return (
    <div className="relative" ref={menuRef}>
      <button
        type="button"
        className="relative inline-flex items-center gap-1 px-3 pt-1 pb-0.5 rounded-full bg-[#f9ae37] text-black font-mohr hover:bg-tertiary/80 transition-colors focus:outline-none border border-black"
