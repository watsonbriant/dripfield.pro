        ...
        <div className="space-y-4 text-fifth text-sm">
          ...
          <div>
            ...
            <ul className="list-disc pl-5 space-y-1 mt-1 font-light">
              ...
              <li>Compared to the band's recordings on Bandcamp, and other setlist tracking sites, we track all performances of every song, regardless if the band lists them in Coach's Notes.&nbsp;&nbsp;For example, songs like <span className="font-medium text-[#a9682e]">Interlude II</span>, <span className="font-medium text-[#a9682e]">(dawn)</span>, <span className="font-medium text-[#a9682e]">Travelers I</span>, <span className="font-medium text-[#a9682e]">Welcome to Delta</span>, and others are available to be selected for your submission, and will be included in the setlist if they're played.</li>
