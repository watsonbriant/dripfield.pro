          ...
          <div className="m-8">
            ...
            <p className="text-wl-white text-left leading-[1.25rem] mt-4">
              ...
              <a
                ...
                className="text-wl-orange hover:text-wl-light-orange underline font-medium"
              >
                Community
              </a>
              !
            ...
            <div className="text-wl-white space-y-4 font-normal text-sm leading-[1.125rem]">
              <div className="mb-4">
                <img
                  ...
                  alt="Michael Basty"
                  className="float-right ml-4 mb-2 w-36 h-auto rounded-lg shadow-xl transition-transform duration-300 hover:scale-105"
                />
                <h2 className="text-wl-white text-lg leading-[1.25rem] font-bold mb-2">Michael &quot;Mjbasty1&quot; Basty</h2>
                <p>
                ...
                <ul className="list-disc list-outside my-2 space-y-1 pl-5">
                  <li>Formerly Incarcerated #criminaljusticereform</li>
                  <li>Friend of Bill W.</li>
                  <li>B4L</li>
                  <li>The Greatest Radio Program Director Who Has Ever Lived</li>
                  <li>Supreme Show Buddy</li>
                </ul>
                <p className="font-medium mt-3">Michael says:</p>
                <blockquote className="mt-2 flex overflow-hidden rounded-lg">
                  <div className="w-1 flex-shrink-0 rounded-l-lg bg-wl-orange" aria-hidden />
                  <div className="flex-1 px-4 py-2 bg-wl-orange/20 text-wl-white text-xs rounded-r-lg">
            ...
            <div className="text-wl-white space-y-4 font-normal text-sm leading-[1.125rem]">
              <div className="mb-4">
                <img
                  src="https://wtedradio.com/img/tug.jpeg"
                  alt="Tug Martin"
                  className="float-right ml-4 mb-2 w-36 h-auto rounded-lg shadow-xl transition-transform duration-300 hover:scale-105"
                />
                <h2 className="text-wl-white text-lg leading-[1.25rem] font-bold mb-2">Tug &quot;OldManRising&quot; Martin</h2>
                <p>
                ...
                <p className="font-medium mt-3">Tug says:</p>
                <blockquote className="mt-2 flex overflow-hidden rounded-lg">
                  <div className="w-1 flex-shrink-0 rounded-l-lg bg-wl-orange" aria-hidden />
                  <div className="flex-1 px-4 py-2 bg-wl-orange/20 text-wl-white text-xs rounded-r-lg">
            ...
            <div className="text-wl-white space-y-4 font-normal text-sm leading-[1.125rem]">
              <div className="mb-4">
                <img
                  src="https://wtedradio.com/img/brett.jpg"
                  alt="Brett Dunkin"
                  className="float-right ml-4 mb-2 w-36 h-auto rounded-lg shadow-xl transition-transform duration-300 hover:scale-105"
                />
                <h2 className="text-wl-white text-lg leading-[1.25rem] font-bold mb-2">Brett &quot;Grateful Goose Gizzard Biscuits&quot; Dunkin</h2>
                <p>
                ...
                <p className="font-medium mt-3">Brett says:</p>
                <blockquote className="mt-2 flex overflow-hidden rounded-lg">
                  <div className="w-1 flex-shrink-0 rounded-l-lg bg-wl-orange" aria-hidden />
                  <div className="flex-1 px-4 py-2 bg-wl-orange/20 text-wl-white text-xs rounded-r-lg">
            ...
            <div className="text-wl-white space-y-4 font-normal text-sm leading-[1.125rem]">
              <div className="mb-4">
                <img
                  src="https://wtedradio.com/img/sim.jpg"
                  alt="Simeon Turner"
                  className="float-right ml-4 mb-2 w-36 h-auto rounded-lg shadow-xl transition-transform duration-300 hover:scale-105"
                />
                <h2 className="text-wl-white text-lg leading-[1.25rem] font-bold mb-2">Simeon &quot;SimTurner&quot; Turner</h2>
                <p>
                ...
                <p className="font-medium mt-3">Sim says:</p>
                <blockquote className="mt-2 flex overflow-hidden rounded-lg">
                  <div className="w-1 flex-shrink-0 rounded-l-lg bg-wl-orange" aria-hidden />
                  <div className="flex-1 px-4 py-2 bg-wl-orange/20 text-wl-white text-xs rounded-r-lg">
            ...
            <div className="text-wl-white space-y-4 font-normal text-sm leading-[1.125rem]">
              <div className="mb-4">
                <img
                  src="https://wtedradio.com/img/ben.jpg"
                  alt="Ben McDermott"
                  className="float-right ml-4 mb-2 w-36 h-auto rounded-lg shadow-xl transition-transform duration-300 hover:scale-105"
                />
                <h2 className="text-wl-white text-lg leading-[1.25rem] font-bold mb-2">Ben &quot;BenChasingSatellites&quot; McDermott</h2>
                <p>
                ...
                <p className="font-medium mt-3">Ben says:</p>
                <blockquote className="mt-2 flex overflow-hidden rounded-lg">
                  <div className="w-1 flex-shrink-0 rounded-l-lg bg-wl-orange" aria-hidden />
                  <div className="flex-1 px-4 py-2 bg-wl-orange/20 text-wl-white text-xs rounded-r-lg">
            ...
            <div className="text-wl-white space-y-4 font-normal text-sm leading-[1.125rem]">
              <div className="mb-4">
                <img
                  src="https://wtedradio.com/img/shawna.jpg"
                  alt="Shawna Boynton"
                  className="float-right ml-4 mb-2 w-36 h-auto rounded-lg shadow-xl transition-transform duration-300 hover:scale-105"
                />
                <h2 className="text-wl-white text-lg leading-[1.25rem] font-bold mb-2">Shawna &quot;ShawnaLee&quot; Boynton</h2>
                <p>
                ...
                <p className="font-medium mt-3">Shawna says:</p>
                <blockquote className="mt-2 flex overflow-hidden rounded-lg">
                  <div className="w-1 flex-shrink-0 rounded-l-lg bg-wl-orange" aria-hidden />
                  <div className="flex-1 px-4 py-2 bg-wl-orange/20 text-wl-white text-xs rounded-r-lg">
            ...
            <div className="text-wl-white space-y-4 font-normal text-sm leading-[1.125rem]">
              <div className="mb-4">
                <img
                  src="https://wtedradio.com/img/kyle.jpg"
                  alt="Kyle French"
                  className="float-right ml-4 mb-2 w-36 h-auto rounded-lg shadow-xl transition-transform duration-300 hover:scale-105"
                />
                <h2 className="text-wl-white text-lg leading-[1.25rem] font-bold mb-2">Kyle &quot;WysteriaLane&quot; French</h2>
                <p>
                  Kyle lives in Bedford, TX (a suburb of Dallas/Fort Worth) with his wife since 2009 and his daughter, their only child, born in 2015. He once wrote, in as brief a way possible, about their lives and relationship with the band for the El Goose Times, featured in the STTF/EGT collaboration issue. Kyle also hosts his primary Goose blog space at{' '}
                  <a
                ...
                <p className="font-medium mt-3">Kyle says:</p>
                <blockquote className="mt-2 flex overflow-hidden rounded-lg">
                  <div className="w-1 flex-shrink-0 rounded-l-lg bg-wl-orange" aria-hidden />
                  <div className="flex-1 px-4 py-2 bg-wl-orange/20 text-wl-white text-xs rounded-r-lg">
            ...
            <div className="text-wl-white space-y-4 font-normal text-sm leading-[1.125rem]">
              <div className="mb-4">
                <img
                  src="https://wtedradio.com/img/corey.jpg"
                  alt="Corey Terrell"
                  className="float-right ml-4 mb-2 w-36 h-auto rounded-lg shadow-xl transition-transform duration-300 hover:scale-105"
                />
                <h2 className="text-wl-white text-lg leading-[1.25rem] font-bold mb-2">Corey &quot;BeefofAges&quot; Terrell</h2>
                <p>
                  Corey is a{' '}
                  <a
                    href="https://community.WysteriaLane.org"
                  ...
                  {' '}administrator, station manager for WTED Goose Radio, and profoundly silly person. He handles all of the gory, behind-the-scenes technical details that make Wysteria Lane, the Community, WTED Radio, and the Goosemas Night Zero livestream run smoothly. And when they don&apos;t run smoothly, it&apos;s probably because he did something real dumb, for which he proactively apologizes.
                </p>
                <p className="mt-2">
                ...
                <p className="font-medium mt-3">Corey says:</p>
                <blockquote className="mt-2 flex overflow-hidden rounded-lg">
                  <div className="w-1 flex-shrink-0 rounded-l-lg bg-wl-orange" aria-hidden />
                  <div className="flex-1 px-4 py-2 bg-wl-orange/20 text-wl-white text-xs rounded-r-lg">
