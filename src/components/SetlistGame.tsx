                      ...
                      return (
                        ...
                        <td className="px-4 py-1 text-[#fce7ca]/90 whitespace-nowrap">
                          <span className="font-semibold">
                            <button
                              onClick={() => {
                                if (!show.isSelectionClosed && !show.show_scored && user) {
                                  handleSelectSongs(show);
                                } else if (show.submission_id && (show.isSelectionClosed || show.show_scored)) {
                                  // View mode if show is closed or scored and user has a submission
                                  handleViewSubmission(show);
                                } else if (show.isSelectionClosed || show.show_scored) {
                                  alert('Selections are closed for this show');
                                } else {
                                  alert('Please login to select songs');
                                }
                              }}
